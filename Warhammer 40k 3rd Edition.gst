...
<gameSystem name="Warhammer 40k 3rd Edition" id="96e2-b781-50d7-3d18" authorName="Snyder" battleScribeVersion="2.03" revision="4" type="gameSystem" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
        ...
        <categoryLink name="HQ" id="9c02-ec48-1124-380f" hidden="false" primary="false" targetId="a8a7-7a4b-5f7e-2138">
          ...
          <modifiers>
            <modifier field="6d1d-6801-aa7b-ea91" type="increment" value="1">
              <repeats>
                <repeat childId="9bbd-df2b-520d-778d" field="4ed5-2f92-9abc-2870" includeChildForces="false" includeChildSelections="false" percentValue="false" repeats="1" roundUp="false" scope="force" shared="true" value="750"/>
              </repeats>
            </modifier>
            ...
            <modifier field="79c8-d712-b3f8-3fbc" type="decrement" value="1">
              <conditions>
                <condition childId="9bbd-df2b-520d-778d" field="selections" includeChildForces="false" includeChildSelections="false" percentValue="false" scope="force" shared="true" type="greaterThan" value="0"/>
              </conditions>
            </modifier>
          </modifiers>
        </categoryLink>
      ...
      <categoryLinks>
        ...
        <categoryLink name="HQ" id="f801-8c9d-fa6d-39e7" hidden="false" primary="false" targetId="a8a7-7a4b-5f7e-2138">
          ...
          <modifiers>
            ...
            <modifier field="dce7-0551-bd25-f2fe" type="decrement" value="1">
              <conditions>
                <condition childId="9bbd-df2b-520d-778d" field="selections" includeChildForces="false" includeChildSelections="false" percentValue="false" scope="force" shared="true" type="greaterThan" value="0"/>
              </conditions>
            </modifier>
      ...
      <categoryLinks>
        ...
        <categoryLink name="HQ" id="26d1-77bc-1a33-8119" hidden="false" primary="false" targetId="a8a7-7a4b-5f7e-2138">
          ...
          <modifiers>
            ...
            <modifier field="e4d2-bf42-4306-3692" type="decrement" value="1">
              <conditions>
                <condition childId="9bbd-df2b-520d-778d" field="selections" includeChildForces="false" includeChildSelections="false" percentValue="false" scope="force" shared="true" type="greaterThan" value="0"/>
              </conditions>
            </modifier>
      ...
      <categoryLinks>
        ...
        <categoryLink name="HQ" id="d1de-50cf-619d-864f" hidden="false" primary="false" targetId="a8a7-7a4b-5f7e-2138">
          ...
          <modifiers>
            ...
            <modifier field="f10d-43f1-775e-1609" type="decrement" value="1">
              <conditions>
                <condition childId="9bbd-df2b-520d-778d" field="selections" includeChildForces="false" includeChildSelections="false" percentValue="false" scope="force" shared="true" type="greaterThan" value="0"/>
              </conditions>
            </modifier>
      ...
      <categoryLinks>
        ...
        <categoryLink name="HQ" id="fe0a-de5b-3419-374f" hidden="false" primary="false" targetId="a8a7-7a4b-5f7e-2138">
          ...
          <modifiers>
            ...
            <modifier field="71fe-e8b3-a2c2-dbd1" type="decrement" value="1">
              <conditions>
                <condition childId="9bbd-df2b-520d-778d" field="selections" includeChildForces="false" includeChildSelections="false" percentValue="false" scope="force" shared="true" type="greaterThan" value="0"/>
              </conditions>
            </modifier>
      ...
      <categoryLinks>
        ...
        <categoryLink name="HQ" id="25f7-5155-8ed0-1bed" hidden="false" primary="false" targetId="a8a7-7a4b-5f7e-2138">
          ...
          <modifiers>
            ...
            <modifier field="004b-86dd-21b7-fdee" type="decrement" value="1">
              <conditions>
                <condition childId="9bbd-df2b-520d-778d" field="selections" includeChildForces="false" includeChildSelections="false" percentValue="false" scope="force" shared="true" type="greaterThan" value="0"/>
              </conditions>
            </modifier>
...
-Cannot fire any weapons when moved more than 12&quot;</description>
    ...
    <rule name="Combi Weapons" id="e65f-0536-e057-e2d2" hidden="false"/>
...
Blind/smoke grenades are used in the Shooting phase instead of the unit firing any weapons. Mark the unit as using its blind/smoke grenades by placing cotton wool around them. A unit cannot assault on the same turn it uses blind/smoke grenades. The blind/smoke screen lasts until the start of the player&apos;s next turn and until then the unit counts as in cover with a 5+ cover save. Because they count as being in cover, models in the unit will also strike first if assaulting, unless the enemy is armed with something like frag grenades, or has an ability that allows them to always strike first.</description>
    ...
    <rule name="Agile" id="ff23-7bbc-5d8a-8461" hidden="false">
      <description> Agile vehicles are quite fast and manoeuvrable, but don&apos;t have the straight-line speed if a fast vehicle. They Can move up to 6&quot; and fire all weapons, or up to 12&quot; and fire one. They may not move more than 12&quot;. They can turn freely as they move, like most other vehicles.</description>
    </rule>
  </sharedRules>
  <sharedSelectionEntries>
              ...
              <selectionEntryGroups>
                <selectionEntryGroup name="Weapon Options" id="b704-b0ec-820d-793f" collective="false" hidden="false" import="true">
                  ...
                  <selectionEntryGroups>
                    <selectionEntryGroup name="Special Weapon" id="96b4-ed13-0bc9-dd90" collective="false" hidden="false" import="true">
                      ...
                      <selectionEntries>
                        <selectionEntry name="Heavy Bolter w/ Hellfire Ammo and Suspensors" id="36dd-f074-fdbf-8577" collective="false" hidden="false" import="true" type="upgrade">
                          ...
                          <profiles>
                            <profile name="Heavy Bolter w/Suspensors" id="cc4f-1b64-a80a-b6f8" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
                              <characteristics>
                                <characteristic name="Range" typeId="deb8-131d-bdcf-1376">18&quot;</characteristic>
                                <characteristic name="S" typeId="24d8-2110-08fa-d844">5</characteristic>
                                <characteristic name="AP" typeId="25ce-028f-0aae-2855">4</characteristic>
                            ...
                            <profile name="Heavy Bolter w/ Hellfire Ammo" id="48a4-1033-7b19-199b" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
                              <characteristics>
                                <characteristic name="Range" typeId="deb8-131d-bdcf-1376">36&quot;</characteristic>
                        ...
                        <selectionEntry name="Bolter 2/ M.40 Targeter" id="0f0a-431b-fa7e-72e6" collective="false" hidden="false" import="true" type="upgrade">
                          <costs>
                            <cost name="pts" typeId="4ed5-2f92-9abc-2870" value="10"/>
                          </costs>
                          <profiles>
                            <profile name="Bolter 2/ M.40 Targeter" id="30ce-6619-3edc-2d25" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
                              <characteristics>
                                <characteristic name="Range" typeId="deb8-131d-bdcf-1376">24&quot;</characteristic>
                                <characteristic name="S" typeId="24d8-2110-08fa-d844">4</characteristic>
                                <characteristic name="AP" typeId="25ce-028f-0aae-2855">5</characteristic>
                    ...
                    <selectionEntryGroup name="Special Bolter Ammo" id="21d7-c030-23fc-b4b0" collective="false" hidden="false" import="true">
                      <constraints>
                        <constraint id="ff8a-8abc-807d-a6f0" field="selections" includeChildForces="false" includeChildSelections="false" percentValue="false" scope="parent" shared="true" type="max" value="1"/>
                      </constraints>
                      <selectionEntries>
                        <selectionEntry name="Metal Storm Bolts" id="184c-86c6-8076-8515" collective="false" hidden="false" import="true" type="upgrade">
                          <costs>
                            <cost name="pts" typeId="4ed5-2f92-9abc-2870" value="5"/>
                          </costs>
                          <profiles>
                            <profile name="Metal Storm Bolts" id="5c28-b562-6e20-0434" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
                              <characteristics>
                                <characteristic name="Range" typeId="deb8-131d-bdcf-1376">18&quot;</characteristic>
                                <characteristic name="S" typeId="24d8-2110-08fa-d844">3</characteristic>
                                <characteristic name="AP" typeId="25ce-028f-0aae-2855">-</characteristic>
                        ...
                        <selectionEntry name="Inferno Bolts" id="ccc4-7e05-2e57-652e" collective="false" hidden="false" import="true" type="upgrade">
                          <costs>
                            <cost name="pts" typeId="4ed5-2f92-9abc-2870" value="5"/>
                          </costs>
                          <profiles>
                            <profile name="Inferno Bolts" id="771e-95d6-b677-8024" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
                              <characteristics>
                                <characteristic name="Range" typeId="deb8-131d-bdcf-1376">24&quot;</characteristic>
                                <characteristic name="S" typeId="24d8-2110-08fa-d844">4</characteristic>
                                <characteristic name="AP" typeId="25ce-028f-0aae-2855">5</characteristic>
                        ...
                        <selectionEntry name="Kraken Bolts" id="0051-b262-77e0-1d5b" collective="false" hidden="false" import="true" type="upgrade">
                          <costs>
                            <cost name="pts" typeId="4ed5-2f92-9abc-2870" value="5"/>
                          </costs>
                          <profiles>
                            <profile name="Kraken Bolts" id="0363-2376-73ca-2ae1" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
                              <characteristics>
                                <characteristic name="Range" typeId="deb8-131d-bdcf-1376">30&quot;</characteristic>
                                <characteristic name="S" typeId="24d8-2110-08fa-d844">4</characteristic>
                                <characteristic name="AP" typeId="25ce-028f-0aae-2855">4</characteristic>
    ...
    <selectionEntry name="Additional Options" id="955f-86dd-474a-8af4" collective="false" hidden="false" import="true" type="upgrade">
      <constraints>
